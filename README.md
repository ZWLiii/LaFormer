...
- The code of [PyramidMamba](cropseg/models/PyramidMamba.py) is released.
...
```
python GeoSeg/loveda_test.py -c GeoSeg/config/loveda/dcswin.py -o fig_results/loveda/dcswin_test -t 'd4'  --val
```
